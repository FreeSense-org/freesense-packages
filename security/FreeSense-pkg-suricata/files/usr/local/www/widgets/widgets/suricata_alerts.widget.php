...
<div id="widget-<?=$widgetname?>_card-footer" class="card-footer collapse">
	<input type="hidden" id="suricata_alerts-config" name="suricata_alerts-config" value="" />
		<form action="/widgets/widgets/suricata_alerts.widget.php" method="post" name="iformd" class="">
			<div class="row mb-3">
				<label for="widget_suricata_display_lines" class="col-sm-4 col-form-label"><?=gettext('Alerts to Display:')?></label>
				<div class="col-sm-3">
