...
?>
<form action="suricata_rules_flowbits.php" method="post" enctype="multipart/form-data" class="" name="iform" id="iform">
<input type="hidden" name="id" value="<?=$id;?>"/>
<input type="hidden" name="referrer" value="<?=$referrer;?>"/>
<input type="hidden" name="sid" id="sid" value=""/>
<input type="hidden" name="gid" id="gid" value=""/>
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext("Auto-Generated Flowbit-Required Rules")?></h2></div>
	<div class="card-body">
		<?php
...
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext("Flowbit-Required Rules for {$if_friendly}")?></h2></div>
	<div class="card-body">
		...
		<div class="content clearfix">
			<button type="submit" class="btn btn-secondary btn-sm btn-success float-end" id="cancel" name="cancel" title="<?=gettext('Return to previous page');?>">
