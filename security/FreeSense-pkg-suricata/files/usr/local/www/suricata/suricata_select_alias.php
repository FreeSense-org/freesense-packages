...
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext("Select an Alias to use from the list below")?></h2></div>
...
<nav class="action-buttons">
	...
	<input type="Submit" name="cancel" value="Cancel" id="cancel" class="btn btn-secondary" title="<?=gettext("Cancel import operation and return");?>"/>
</nav>
<div class="infoblock">
<?php }
