			...
			foreach ($a_frontend as $frontend) {
				...
				?>
				  ...
				  <td class="action-buttons">
					<button style="display: none;" class="btn btn-secondary btn-sm" type="submit" id="move_<?=$frontendname?>" name="move_<?=$frontendname?>" value="move_<?=$frontendname?>"></button>
