...
/* Compatibility function for FreeSense 2.0 */
...
$section->addInput(new Form_StaticText(
	...
	Certificates can be imported into the <a href="/system_camanager.php" target="_blank">FreeSense "Certificate Authority Manager"</a>
