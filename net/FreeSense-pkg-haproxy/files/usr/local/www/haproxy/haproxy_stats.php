...
?>
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Stats")?></h2>
		</div>
		<div class="table-responsive card-body">
			This page contains a 'stats' page available from haproxy accessible through the FreeSense gui.<br/>
			<br/>
			As the page is forwarded through the FreeSense gui, this might cause some functionality to not work.<br/>
			Though the normal haproxy stats page can be tweaked more, and doesn't use a user/pass from FreeSense itself.<br/>
	...
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("HAProxy stick-tables")?></h2>
		</div>
		<div class="table-responsive card-body">
			...
			<table  class="table table-hover table-striped table-sm sortable-theme-bootstrap" data-sortable id="sortabletable">
			<thead>
				<tr>
	...
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("HAProxy DNS statistics")?></h2>
		</div>
		<div class="table-responsive card-body">
	...
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("HAProxy stats")?></h2>
		</div>
		<div class="table-responsive card-body">
