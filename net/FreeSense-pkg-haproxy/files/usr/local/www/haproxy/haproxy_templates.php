...
<form action="haproxy_templates.php" method="post">
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Templates")?></h2>
		</div>
	...
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Serving multiple domains from 1 frontend")?></h2>
		</div>
		<div class="table-responsive card-body">
			<div class="col-sm-3">
	...
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Stats SSL frontent+backend")?></h2>
		</div>
		<div class="table-responsive card-body">
			<div class="col-sm-3">
			...
			<div class="col-sm-8">
				...
				<br/>
				After applying the changes made by the template use this link to visit the stats page: <a target="_blank" href="https://<?=get_interface_ip("lan");?>:444">https://FreeSense-LAN-ip:444/</a>
			</div>
		</div>
		<br/>
	</div>
	<div class="card mb-3">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Errorfile")?></h2>
		</div>
		<div class="table-responsive card-body">
			<div class="col-sm-3">
