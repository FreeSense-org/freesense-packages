...
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext('Configured Instances');?></h2></div>
	<div class="table-responsive card-body">
		<form action="/udpbroadcastrelay/udpbroadcastrelay.php" method="post">
			<input type="hidden" name="list_id" id="list_id" value=""/>
			<table id="maintable" class="table table-striped table-hover table-sm table-rowdblclickedit">
				<thead>
					<tr>
