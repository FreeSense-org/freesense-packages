...
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext('Bridges')?></h2></div>
	<div class="card-body">
		<div class="table-responsive">
			<table id="bridge_services" class="table table-striped table-hover table-sm table-rowdblclickedit">
				<thead>
					<tr>
						<th></th>
