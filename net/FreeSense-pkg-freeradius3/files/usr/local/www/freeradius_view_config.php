...
<div class="card mb-3">
	<div class="card-header"><h2 class="h5 mb-0"><?=gettext("View FreeRADIUS Configuration Files"); ?></h2></div>
	<div class="card-body">
			...
			<table class="table table-hover table-sm">
				...
				<tr>
					<th class="text-center">
						<div class="btn-group">
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('radiusd');" id='btn_radiusd' value="radiusd.conf">
								<i class="fa-regular fa-file-lines"></i>
								radiusd.conf
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('eap');" id='btn_eap' value="eap.conf">
								<i class="fa-regular fa-file-lines"></i>
								eap
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('sql');" id='btn_sql' value="sql.conf">
								<i class="fa-regular fa-file-lines"></i>
								sql
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('clients');" id='btn_clients' value="clients.conf">
								<i class="fa-regular fa-file-lines"></i>
								clients.conf
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('users');" id='btn_users' value="users">
								<i class="fa-regular fa-file-lines"></i>
								users
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('macs');" id='btn_macs' value="macs">
								<i class="fa-regular fa-file-lines"></i>
								macs
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('virtual-server-default');" id='btn_virtual-server-default' value="virtual-server-default">
								<i class="fa-regular fa-file-lines"></i>
								virtual-server-default
							</button>
							<button type="button" class="btn btn-secondary btn-sm" onClick="get_freeradius_file('ldap');" id='btn_ldap' value="ldap">
								<i class="fa-regular fa-file-lines"></i>
								ldap
							</button>
						</div>
