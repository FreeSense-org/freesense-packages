...
?>
	<div class="table-responsive">
		<table class="table table-hover table-striped table-sm" style="overflow-x: visible;">
			<thead>
...
<div id="widget-<?=htmlspecialchars($widgetkey)?>_card-footer" class="card-footer collapse">

	<form action="/widgets/widgets/<?=$widgetconfig['basename']?>.widget.php" method="post" class="">
		<input type="hidden" name="widgetkey" value="<?=htmlspecialchars($widgetkey)?>" />
		<input type="hidden" name="save" value="save" />

		<div class="row mb-3">
			<label for="<?=htmlspecialchars($widgetkey)?>_refresh_interval" class="col-sm-4 col-form-label"><?=gettext('Refresh Interval')?></label>
			<div class="col-sm-8">
		...
		<div class="row mb-3">
			<label for="<?=htmlspecialchars($widgetkey)?>_activity_threshold" class="col-sm-4 col-form-label">
