...
$tun_enable->setHelp('<span class="text-danger">Note: </span>Tunnel must be <b>enabled</b> in order to be assigned to a FreeSense interface.');	
...
if (is_wg_tunnel_assigned($pconfig['name'])) {
	...
	$tun_enable->setHelp('<span class="text-danger">Note: </span>Tunnel cannot be <b>disabled</b> when assigned to a FreeSense interface.');
...
<div class="card mb-3">
	<div class="card-header">
		<h2 class="h5 mb-0"><?=gettext('Peer Configuration')?></h2>
	</div>
	<div id="mainarea" class="table-responsive card-body">
		<table id="peertable" class="table table-hover table-striped table-sm" style="overflow-x: visible;">
			<thead>
				<tr>
