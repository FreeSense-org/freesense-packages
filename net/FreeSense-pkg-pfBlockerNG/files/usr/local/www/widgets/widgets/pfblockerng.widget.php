...
function pfBlockerNG_update_table() {
	...
	if (!empty($pfb_filter_rules)) {
		...
		if (!empty($tracked_rules)) {
			foreach (FreeSense_get_pf_rules() as $prule) {
			...
			if (strpos($pfb_alias, 'DNSBL_') !== FALSE) {
				...
				if ($values['count'] > 0 && $pfb['popup'] == 'on') {
					$pfb_alias = "<a href=\"/firewall_aliases_edit.php?id={$values['id']}\" data-popover=\"true\" "
						. " data-bs-trigger=\"hover focus\" title=\"pfBlockerNG Alias details\" data-bs-content=\""
						. alias_info_popup($values['id']) . "\" data-bs-html=\"true\">{$pfb_alias}</a>";
				}
			}
...
<form id="formicons" action="/widgets/widgets/pfblockerng.widget.php" method="post" class="">
...
<input type="hidden" name="pfblockerngcleardnsbl" id="pfblockerngcleardnsbl" value="">
	...
	<div class="table-responsive" style="max-height: <?=$pfb['maxheight'];?>px; overflow: auto;">
		<table id="pfb-tbl" class="table table-striped table-hover table-sm sortable-theme-bootstrap" data-sortable>
			<thead>
				<tr>
...
<div id="widget-<?=$widgetname?>_card-footer" class="card-footer collapse">

<form action="/widgets/widgets/pfblockerng.widget.php" method="post" class="">
	<div class="row mb-3">
		<label class="col-sm-8 col-form-label">Enable Alias Table Popup</label>
	...
	<div class="row mb-3">
		<label for="pfb_clearip" class="col-sm-8 col-form-label">Enter frequency to clear the IP counters</label>
		<div class="col-sm-4">
	...
	<div class="row mb-3">
		<label for="pfb_cleardnsbl" class="col-sm-8 col-form-label">Enter frequency to clear the DNSBL/Unbound counters</label>
		<div class="col-sm-4">
	...
	<div class="row mb-3">
		<label for="pfb_dnsblquery" class="col-sm-8 col-form-label">Enter DNSBL Resolver Query frequency (Default:5)</label>
		<div class="col-sm-4">
	...
	<div class="row mb-3">
		<label for="pfb_maxfails" class="col-sm-8 col-form-label">Enter number of download fails to display (default:3)</label>
		<div class="col-sm-3">
	...
	<div class="row mb-3">
		<label for="pfb_sortcolumn" class="col-sm-8 col-form-label">Enter Sort Column</label>
		<div class="col-sm-4">
	...
	<div class="row mb-3">
		<label for="pfb_sortmix" class="col-sm-8 col-form-label"><?=gettext('Combined sort (IP/DNSBL)')?></label>
		<div class="col-sm-2 checkbox">
	...
	<div class="row mb-3">
		<label for="pfb_sortdir" class="col-sm-8 col-form-label"><?=gettext('Select sort direction')?></label>
		<div class="col-sm-4">
	...
	<div class="row mb-3">
		<label for="pfb_maxheight" class="col-sm-8 col-form-label"><?=gettext('Widget max height in px (default:2500)')?></label>
		<div class="col-sm-3">
