...
if ($_POST) {
	if (isset($_POST['save'])) {
		...
		if (!$input_errors) {
			...
			// Python TLD Allow (Add default TLD Allows + ARPA + FreeSense TLD
...
$dnsbl_text = '<div class="infoblock">
			...
			<ol>
				...
				<li>Execute the following command from FreeSense Shell (Changing the interface \'re1\' to the FreeSense Lan Interface):<br />
...
$section->addInput(new Form_Select(
	...
	$options_dnsbl_mode
		...
		. '&emsp;&emsp;&emsp;&emsp;This mode is only available for FreeSense version 2.4.5 and above.<br />'
...
$section->addInput(new Form_Checkbox(
	...
	. 'The python_control feature is limited to DNS TXT records sent from FreeSense localhost (127.0.0.1) only!<br />'
...
$section->addInput(new Form_Checkbox(
	...
	'on'
		...
		. '<strong>By default</strong> \'ARPA\' and the FreeSense TLD \'' . strtoupper($local_tld) . '\' are allowed.<br />'
...
events.push(function(){
	...
	$('label[class="col-sm-2 col-form-label"]').each(function() {
		var found = $(this).text();
