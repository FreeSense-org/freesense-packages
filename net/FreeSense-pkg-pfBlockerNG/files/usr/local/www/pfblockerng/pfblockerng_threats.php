...
<div class="card mb-3">
	<div class="card-header">
		<h4 class="h5 mb-0"><?=gettext("Threat {$title}:&emsp;" . $host . $domain . $port); ?></h4>
	</div>
	<div>
	...
	<div>
		<table class="table table-striped table-hover table-compact">
			...
			<tbody>
				...
				<tr>
					<td><span style="color: blue;">Threat Lookups</span><i class="fa-solid fa-globe float-end"></i></td>
				...
				<tr>
					<td><span style="color: blue;">Mail Server Lookups</span><i class="fa-solid fa-envelope float-end"></i></td>
					<td><a target="_blank" href="https://senderscore.org/lookup.php?lookup=<?=$host;?>&ipLookup=Go">
						<?=gettext("SenderScore");?></a></td>
				</tr>
				<tr>
					<td><i class="fa-solid fa-envelope float-end"></i></td>
				...
				<tr>
					<td>Domain Lookups<i class="fa-solid fa-globe float-end"></i></td>
