...
?>
<form action="/pfblockerng/pfblockerng_feeds.php" method="post" name="iform" id="iform" class="">
<?php
...
<div class="card mb-3">
	<div class="card-header">
		<h2 class="h5 mb-0"><?=gettext("Pre-defined Alias/Group/Feeds")?></h2>
	</div>
	...
	<div id="pfb_table" class="card-body">
...
<div class="card mb-3">
	<div class="card-header">
		<h2 class="h5 mb-0"><?=gettext("Unknown user defined Feeds")?></h2>
	</div>
	<div id="pfb_table2" class="card-body">
		<div class="table-responsive">
