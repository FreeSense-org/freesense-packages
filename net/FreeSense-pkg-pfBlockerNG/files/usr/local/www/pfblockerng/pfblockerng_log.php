 ...
 * Snort package for FreeSense from the following contributors:
 *
...
$section->addInput(new Form_StaticText(
	...
	. '<div style="display:inline; margin-right:10px;" class="float-end" id="fileRefreshBtn">'
	. $logbtns . '</div></div>'
));
$form->add($section);
...
events.push(function() {
	...
	$('label[class="col-sm-2 col-form-label"]:eq(3)').remove();
