...
<form class=" in auto-submit" method="post" action="/status_traffic_totals.php" id="traffic-totals-settings-form">
	<div class="card mb-3" id="traffic-totals-settings-panel">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Settings"); ?>
				<span class="widget-heading-icon">
					<a data-bs-toggle="collapse" href="#traffic-totals-settings-panel_panel-body">
						<i class="fa-solid fa-plus-circle"></i>
					</a>
				</span>
			</h2>
		</div>
		<div id="traffic-totals-settings-panel_panel-body" class="card-body collapse show">
			<div class="row mb-3">
...
<div class="card mb-3">
	<div class="card-header">
		<h2 class="h5 mb-0">Interactive Graph</h2>
	</div>
	<div class="card-body">
...
<div class="card mb-3">
	<div class="card-header">
		<h2 class="h5 mb-0">Data Summary</h2>
	</div>
	<div class="card-body">
